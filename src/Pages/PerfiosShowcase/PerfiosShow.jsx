...
const PerfiosShow = () => {
  ...
  return (
    <div className='text-white relative'>
      ...
      {/* Back Button - Positioned to be below the Navbar */}
      <button
  onClick={() => navigate(-1)}
  className="absolute top-32 sm:top-36 left-4 sm:left-6 lg:left-8 bg-gray-300 text-black font-semibold px-3 py-1 sm:px-4 sm:py-2 text-sm sm:text-base rounded-md shadow-md hover:bg-gray-200 transition duration-300 z-40"
>
  ← Go Back
</button>

      {/* Main content container with video and description */}
      <div className="pt-12 sm:pt-16 lg:pt-20">
        ...
        <div className="w-full aspect-video">
          {youtubeEmbedUrl ? (
            ...
            <div className="w-full h-full flex items-center text-center justify-center bg-black">
              <p>YouTube video not available for this content</p>
            </div>
          )}
        </div>

        {/* Video Info Section below the video - Styled with glassmorphism */}
      ...
      <div id='details' ref={detailsRef} className=' text-white py-16 px-4'>
        <div className='max-w-4xl mx-auto'>
          ...
          <div  className='bg-gray-900 p-6 rounded-lg mb-5'>
          ...
          <p className='text-gray-300 leading-relaxed open-sans'>{video.description}</p>
